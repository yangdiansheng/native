...
Java_com_yangdainsheng_operations_BitmapOp_callNativeMirrorBitmap(JNIEnv *env, jobject thiz,jobject bitmap) {
    LOGD("mirror bitmap");
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_yangdainsheng_operations_BitmapOp_callNativeRotateBitmap(JNIEnv *env, jobject thiz,jobject bitmap) {
    LOGD("rotate bitmap");
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_yangdainsheng_operations_BitmapOp_callNativeConvertBitmap(JNIEnv *env, jobject thiz,
                                                                   jobject bitmap) {
    LOGD("convert bitmap");
    AndroidBitmapInfo bitmapInfo;
    int ret;
